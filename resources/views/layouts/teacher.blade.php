            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="ni ni-single-02 text-blue"></i> Meu Perfil
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="ni ni-pin-3 text-orange"></i> Trabalhos
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="ni ni-planet text-yellow"></i> Dúvidas
                    </a>
                </li>
            </ul>
        </div>
                       ...
                       aria-expanded="false">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body ml-2 d-none d-lg-block">
                                <span
                                    class="mb-0 text-sm  font-weight-bold">{{ Auth::guard('teacher')->user()->name }}</span>
                            </div>
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
            ...
            <div class="row align-items-center justify-content-xl-between">
                <div class="col-xl-6">
                    <div class="copyright text-center text-xl-left text-muted">
                        &copy; 2019 <a href="javascript:void(0)" class="font-weight-bold ml-1"
                                       target="_blank">Project G</a>
                    </div>
                </div>
                <div class="col-xl-6">
                    <ul class="nav nav-footer justify-content-center justify-content-xl-end">
                        <li class="nav-item">
                            <a href="https://github.com/projectg-univem/projectg"
